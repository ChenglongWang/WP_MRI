...

if(isset($add)){
	easyreservations_build_datepicker(1,array('datepicker','datepicker2', 'reservation_date'), 'm/d/Y');
	add_action('admin_print_footer_scripts','easyreservations_restrict_input_dash');
...
<table  style="width:99%;margin-top:8px" cellspacing="0">
	...
	<td style="width:350px;" valign="top">
		<table class="<?php echo RESERVATIONS_STYLE; ?> withicons">
			...
			//		if(isset($_POST['to-time-hour'])) $totimeh = $_POST['to-time-hour']; else $totimeh = 23;
			//		if(isset($_POST['to-time-min'])) $totimem = $_POST['to-time-min']; else $totimem = 00;?>:</td>
   
					<td><input type="text" id="datepicker2" style="width:80px" name="dateend" value="<?php if(isset($_POST['dateend'])) echo $_POST['dateend']; ?>" onchange="easyreservations_send_price_admin();changer();<?php if($overview_options['overview_autoselect'] == 1){ ?>dofakeClick(2);<?php }?>">
                                        <!--<select name="to-time-hour" id="to-time-hour" onchange="easyreservations_send_price_admin();<?php if($overview_options['overview_autoselect'] == 1){ ?>dofakeClick(0);<?php }?>"><?php echo easyreservations_num_options("24",24,$totimeh); ?></select>点整-->
                                        <!--<select name="to-time-min"><?php echo easyreservations_num_options("00",59,$totimem); ?></select> -->
                         <!--           </td>-->
				</tr>
